...
<!-- ============================================================= -->
<!-- Banner + Vision  (design copied from shrinivaslab.com)         -->
<!-- ============================================================= -->

<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="lazy" path="assets/img/research/cell-art-goodsell-1.jpg" class="img-fluid rounded z-depth-1" title="Banner image" %}
    </div>
</div>
<div class="fadedsmallnote" align="right">
  Adapted from original art of David Goodsell
</div>

#### about

<span class="dottedlinks">
Check <a href="https://wwang721.com">Wei Wang (汪巍)'s homepage</a></span>.
